Public Class frmUpdateSono
    Dim index As Integer
    Dim errmsg As String

    Private Sub frmUpdateSono_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub loadPatDocDetails()
        ...
        txtrefSonoID.Text = dt1.Rows(index).Item(5)
        txtrefSono.Text = dt1.Rows(index).Item(18)
    End Sub
    ...
    Public Sub loadTestValues()
        ...
        txtimpression.Text = dt2.Rows(index).Item(14)

        txtxraytest.Text = dt2.Rows(index).Item(0)
    End Sub
    ...
    Public Sub initialisationLoad()
        ...
        sqlstr = "SELECT B.*,C.Pat_FName,C.Pat_Age,C.Pat_Gender,D.Staff_FName,E.Doc_FName FROM Diagnosis_Tests AS A,Sonography_Tests AS B,Patient_Info AS C, Staff_Info D,Doctor_Info E WHERE B.Pat_ID=A.Pat_ID AND A.Pat_ID=C.Pat_ID AND B.Ref_SonoID=D.Staff_ID AND B.Ref_DocID=E.Doc_ID AND C.Pat_Status='Reg' AND SonoTest='Yes' AND A.S_Test_Status='Done' ORDER BY B.SonoTest_ID ASC"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If updateDialog() = True Then
            Try
                cmd.CommandText = "UPDATE Sonography_Tests SET Pat_ID=@Pat_ID,SonoTest_Date=@SonoTest_Date,SonoTest_Name=@SonoTest_Name,Remark_1=@Remark_1,Remark_2=@Remark_2,Remark_3=@Remark_3,Remark_4=@Remark_4,Remark_5=@Remark_5,Remark_6=@Remark_6,Impression=@Impression WHERE Pat_ID=@Pat_ID"
