Public Class frmImagSonography
    Dim index As Integer
    Dim errmsg As String

    Private Sub frmImagSonography_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmbrefSono_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbrefSono.SelectedIndexChanged
        cmbrefSonoID.SelectedIndex = cmbrefSono.SelectedIndex
    End Sub

    Private Sub cmbrefSonoID_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbrefSonoID.SelectedIndexChanged
        cmbrefSono.SelectedIndex = cmbrefSonoID.SelectedIndex
    End Sub
    ...
    Public Sub initialisationLoad()
        ...
        sqlstr1 = "SELECT Test_ID, Dept_ID FROM Test_Details WHERE Test_Name='Sonography'"
        ...
        sqlstr = "SELECT B.Pat_ID,B.Doc_ID,C.Doc_FName,A.Pat_FName,A.Pat_Age,A.Pat_Gender FROM Patient_Info A, Diagnosis_Tests B ,Doctor_Info C WHERE B.Pat_ID=A.Pat_ID AND C.Doc_ID=B.Doc_ID AND B.SonoTest='Yes' AND B.S_Test_Status='Pending'"
        ...
        sqlstr3 = "SELECT Staff_ID,Staff_FName FROM Staff_Info WHERE Staff_Status='In' AND Staff_Desc='Sonologist'"
        Dim dt3 As DataTable = getDataTable(sqlstr3)
        max3 = dt3.Rows.Count
        For y1 = 0 To max3 - 1
            cmbrefSonoID.Items.Add(dt3.Rows(y1).Item(0))
            cmbrefSono.Items.Add(dt3.Rows(y1).Item(1))
        Next
    ...
    Private Sub insertNewTestRecords()
        ...
        If saveDialog() = True Then
            ...
            Try
                cmd.CommandText = "INSERT INTO Sonography_Tests(SonoTest_ID,Dept_ID,Test_ID,Pat_ID,Ref_DocID,Ref_SonoID,SonoTest_Date,SonoTest_Name,Remark_1,Remark_2,Remark_3,Remark_4,Remark_5,Remark_6,Impression)VALUES(@SonoTest_ID,@Dept_ID,@Test_ID,@Pat_ID,@Ref_DocID,@Ref_SonoID,@SonoTest_Date,@SonoTest_Name,@Remark_1,@Remark_2,@Remark_3,@Remark_4,@Remark_5,@Remark_6,@Impression)"

                cmd.Parameters.AddWithValue("@SonoTest_ID", Val(txtxraytest.Text))
                ...
                cmd.Parameters.AddWithValue("@Ref_SonoID", Val(cmbrefSonoID.Text))
                cmd.Parameters.AddWithValue("@SonoTest_Date", dtpDiagDt.Value.Date)
                cmd.Parameters.AddWithValue("@SonoTest_Name", txtexamname.Text)
                ...
                cmd.Parameters.AddWithValue("@Impression", txtimpression.Text)
                ...
                If res > 0 Then
                    ...
                    Try
                        cmd1.CommandText = "UPDATE Diagnosis_Tests SET Pat_ID=@Pat_ID,S_Test_Status=@S_Test_Status WHERE Pat_ID=@Pat_ID"
                        cmd1.Parameters.AddWithValue("@Pat_ID", Val(cmbPatID.Text))
                        cmd1.Parameters.AddWithValue("@S_Test_Status", "Done")
    ...
    Public Function chkData() As Boolean
        ...
        txtremark6.Text = "" Then
            ...
            chkData = True
        ElseIf txtimpression.Text = "" Then
            errmsg = errmsg & "Impression cannot be blank!"
            chkData = True
        Else
            chkData = False
        End If
    ...
    Private Sub clearPatDetails()
        ...
        cmbrefSonoID.SelectedIndex = -1
        cmbrefSono.SelectedIndex = -1
        txtage.Text = ""
        txtgender.Text = ""
        txtrefdoc.Text = ""
        txtdocID.Text = ""
    ...
    Private Sub incrSonoTest()
        Dim x As Integer
        Dim max2 As Integer
        sqlstr2 = "SELECT SonoTest_ID FROM Sonography_Tests"
