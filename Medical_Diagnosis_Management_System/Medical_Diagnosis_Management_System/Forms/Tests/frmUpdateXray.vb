Public Class frmUpdateXray
    ...
    Public Sub initialisationLoad()
        ...
        sqlstr = "SELECT B.*,C.Pat_FName,C.Pat_Age,C.Pat_Gender,D.Staff_FName,E.Doc_FName FROM Diagnosis_Tests AS A,XRay_Tests AS B,Patient_Info AS C, Staff_Info D,Doctor_Info E WHERE B.Pat_ID=A.Pat_ID AND A.Pat_ID=C.Pat_ID AND B.Ref_RadioID=D.Staff_ID AND B.Ref_DocID=E.Doc_ID AND C.Pat_Status='Reg' AND XrayTest='Yes' AND A.X_Test_Status='Done' ORDER BY B.XRayTest_ID ASC"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        If updateDialog() = True Then
            Try
                cmd.CommandText = "UPDATE XRay_Tests SET Pat_ID=@Pat_ID,XRayTest_Date=@XRayTest_Date,XRayTest_Name=@XRayTest_Name,Remark_1=@Remark_1,Remark_2=@Remark_2,Remark_3=@Remark_3,Remark_4=@Remark_4,Remark_5=@Remark_5,Remark_6=@Remark_6,Opinion=@Opinion WHERE Pat_ID=@Pat_ID"
