...
Public Class BillReportPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Medical_Diagnosis_Management_System.BillReportPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillReportPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillReportPrint = New BillReportPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
